...
function loop_end_action()
{
    if (is_archive()):
        ...
        <p class="after-loop">
            <?php
                echo do_shortcode('[banniere-titre src="https://localhost/2-Projets-WordPress/OpenClassrooms-Bricotips/wp-content/uploads/2024/09/banniere-image.png" titre="BricoTips"]');
            ?>
        </p>
        <?php
   endif;
