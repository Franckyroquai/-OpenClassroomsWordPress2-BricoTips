...
<main id="apropos">
    ...
    <?php
        echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="https://localhost/2-Projets-WordPress/OpenClassrooms-Bricotips/wp-content/uploads/2024/09/banniere-image.png" ]');
    ?>
